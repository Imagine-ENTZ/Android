...
public class TimelineRow {
    ...
    public TimelineRow(int id, String date) {
        this.id = id;
        this.date = date;
    }


    public TimelineRow(int id, String date, String title, String description) {
        this.id = id;
        this.date = date;
        this.title = title;
    ...
    public TimelineRow(int id, String date, String title, String description, Bitmap image, int bellowLineColor, int bellowLineSize, int imageSize, int backgroundColor, int backgroundSize, int dateColor, int titleColor, int descriptionColor) {
        this.id = id;
        this.date = date;
        this.title = title;
        this.description = description;
