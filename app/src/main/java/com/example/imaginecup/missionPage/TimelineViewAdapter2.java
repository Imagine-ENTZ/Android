...
public class TimelineViewAdapter2 extends ArrayAdapter<com.example.imaginecup.missionPage.TimelineRow> {

    private Context context;
    private Resources res;
    private List<com.example.imaginecup.missionPage.TimelineRow> RowDataList;
    private String AND;


    public TimelineViewAdapter2(Context context, int resource, ArrayList<com.example.imaginecup.missionPage.TimelineRow> objects, boolean orderTheList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.example.imaginecup.missionPage.TimelineRow row = RowDataList.get(position);
    ...
    private ArrayList<com.example.imaginecup.missionPage.TimelineRow> rearrangeByDate(ArrayList<TimelineRow> objects) {
